...
class Database extends Context.Service<Database, DatabaseShape>()("@lockcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@lockcode/example/UserStore") {
