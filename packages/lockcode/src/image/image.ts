...
export class Service extends Context.Service<Service, Interface>()("@lockcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __LOCKCODE_PHOTON_WASM_PATH?: string }).__LOCKCODE_PHOTON_WASM_PATH =
