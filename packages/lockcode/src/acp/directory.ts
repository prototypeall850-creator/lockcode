...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@lockcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@lockcode/ACPDirectory") {}
