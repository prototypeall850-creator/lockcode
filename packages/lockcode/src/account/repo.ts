...
import { AccountStateTable, AccountTable } from "@lockcode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/AccountRepo") {}
