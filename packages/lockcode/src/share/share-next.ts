...
import type * as SDK from "@lockcode-ai/sdk/v2"
...
import { SessionShareTable } from "@lockcode-ai/core/share/sql"
...
const disabled = process.env["LOCKCODE_DISABLE_SHARE"] === "true" || process.env["LOCKCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/ShareNext") {}
