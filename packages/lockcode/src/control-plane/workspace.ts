...
import { EventSequenceTable, EventTable } from "@lockcode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@lockcode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        LOCKCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        LOCKCODE_WORKSPACE_ID: config.id,
        LOCKCODE_EXPERIMENTAL_WORKSPACES: "true",
