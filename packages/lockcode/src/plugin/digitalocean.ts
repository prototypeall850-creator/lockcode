import type { Hooks, PluginInput } from "@lockcode-ai/plugin"
import type { Model } from "@lockcode-ai/sdk/v2"
import { InstallationVersion } from "@lockcode-ai/core/installation/version"
import { OauthCallbackPage } from "@lockcode-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. LockCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
