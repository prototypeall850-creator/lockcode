 ...
 *   "@lockcode/ServerAuthConfig",
 *   {
 *     password: Config.string("LOCKCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("LOCKCODE_SERVER_USERNAME").pipe(Config.withDefault("lockcode")),
 *   },
 * ) {}
 *
