...
import { buildPrompt } from "@lockcode-ai/core/session/compaction"
import { SessionCompactionEvent } from "@lockcode-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/SessionCompaction") {}
