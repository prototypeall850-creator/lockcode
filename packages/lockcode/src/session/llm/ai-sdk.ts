import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@lockcode-ai/llm"
...
// Move this extraction into @lockcode-ai/llm when Copilot is handled by the native runtime.
