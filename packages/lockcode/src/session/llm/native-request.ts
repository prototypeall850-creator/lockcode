import type { JsonSchema, LLMRequest, ProviderMetadata } from "@lockcode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@lockcode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
  ...
  OpenAICompatible,
  OpenRouter,
} from "@lockcode-ai/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @lockcode-ai/llm request objects from lockcode's session/AI SDK-shaped data.
  return LLM.request({
