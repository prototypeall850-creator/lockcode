...
import { SessionStatusEvent } from "@lockcode-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/SessionStatus") {}
