...
import { Usage, type LLMEvent } from "@lockcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean lockcode changed history behind a signed
