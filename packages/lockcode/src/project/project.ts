...
import { ProjectDirectoryTable, ProjectTable } from "@lockcode-ai/core/project/sql"
import { ProjectDirectories } from "@lockcode-ai/core/project/directories"
import { SessionTable } from "@lockcode-ai/core/session/sql"
import { WorkspaceTable } from "@lockcode-ai/core/control-plane/workspace.sql"
import { Flag } from "@lockcode-ai/core/flag/flag"
import { GlobalBus } from "@/bus/global"
import { which } from "@lockcode-ai/core/util/which"
...
import { CrossSpawnSpawner } from "@lockcode-ai/core/cross-spawn-spawner"
import { AbsolutePath } from "@lockcode-ai/core/schema"
import { serviceUse } from "@lockcode-ai/core/effect/service-use"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { EventV2Bridge } from "@/event-v2-bridge"
import { EventV2 } from "@lockcode-ai/core/event"
import { Project } from "@lockcode-ai/schema/project"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.LOCKCODE_FAKE_VCS)
