...
>()("@lockcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@lockcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.LOCKCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.LOCKCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-lockcode-directory"] || process.cwd()
}
