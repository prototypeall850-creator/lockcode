...
import { normalizePromptContent } from "@lockcode-ai/tui/editor"
...
import { LOCKCODE_BASE_MODE, useBindings } from "@lockcode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close LockCode" } satisfies SlashOption,
    ]
