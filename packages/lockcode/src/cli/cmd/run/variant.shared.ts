...
//
// The saved variant persists across sessions in ~/.local/state/lockcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@lockcode/RunVariant") {}
