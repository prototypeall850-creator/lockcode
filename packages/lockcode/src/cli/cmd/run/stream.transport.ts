...
import type { Event, GlobalEvent, LockcodeClient } from "@lockcode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@lockcode/RunStreamTransport") {}
