...
import { openEditor } from "@lockcode-ai/tui/editor"
import { registerLockcodeKeymap } from "@lockcode-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerLockcodeKeymap(keymap, renderer, input.tuiConfig)
