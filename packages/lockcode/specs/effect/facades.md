...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/lockcode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy lockcode service removed
