...
Practical reference for the current tool-migration state in `packages/lockcode`.
...
Tool tests should use the existing Effect helpers in `packages/lockcode/test/lib/effect.ts`:
