...
import type { Definition } from "@lockcode-ai/schema/event"
...
export const LockCodeEvent = event.schema
export type LockCodeEvent = typeof LockCodeEvent.Type
export type LockCodeEventEncoded = typeof LockCodeEvent.Encoded
