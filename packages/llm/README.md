...
Schema-first LLM core for lockcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@lockcode-ai/llm"
import { OpenAI } from "@lockcode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@lockcode-ai/llm/providers"
