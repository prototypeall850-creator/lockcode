...
> current private `@lockcode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@lockcode-ai/ai`
...
- Secondary audience: LockCode and other durable agent runtimes
...
import { LLM } from "@lockcode-ai/ai"
import { OpenAI } from "@lockcode-ai/ai/providers/openai"
...
```ts
import { Message } from "@lockcode-ai/ai"
...
import { LLM, Tool } from "@lockcode-ai/ai"
...
LockCode and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@lockcode-ai/ai/promise"
import { OpenAI } from "@lockcode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@lockcode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@lockcode-ai/ai/provider"
...
@lockcode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@lockcode-ai/ai/schema
  serializable domain schemas

@lockcode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@lockcode-ai/ai/providers/openai
@lockcode-ai/ai/providers/anthropic
@lockcode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@lockcode-ai/llm`                      | `@lockcode-ai/ai`                                           |
...
LockCode should migrate to `generateTurn` / `streamTurn`, preserving its durable
