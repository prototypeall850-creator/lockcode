...
import { LOCKCODE_BASE_MODE, useBindings, useCommandShortcut, useLockcodeKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["lockcode", "lockcode-go"])
