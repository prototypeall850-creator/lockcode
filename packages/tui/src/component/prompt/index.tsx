...
import { registerLockcodeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@lockcode-ai/sdk/v2"
...
import { LOCKCODE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useLockcodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.LOCKCODE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
