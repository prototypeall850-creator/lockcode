...
- Effect plugins import `@lockcode-ai/plugin/v2/effect`, not `@lockcode-ai/core`.
- Public domain values use generated `@lockcode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@lockcode-ai/plugin/v2/effect`.
