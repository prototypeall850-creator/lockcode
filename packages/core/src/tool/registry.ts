...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@lockcode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/v2/ToolRegistry") {}
