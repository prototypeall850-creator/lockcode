...
export class Service extends Context.Service<Service, Interface>()("@lockcode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.LOCKCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
