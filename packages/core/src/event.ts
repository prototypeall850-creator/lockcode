...
import type { Data, Definition, Payload } from "@lockcode-ai/schema/event"
...
import { Durable } from "@lockcode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@lockcode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@lockcode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/Event") {}
