...
import { ListAnchor } from "@lockcode-ai/schema/session"
...
import { SessionDurable } from "@lockcode-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/v2/Session") {}
