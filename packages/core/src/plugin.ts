...
import type { Plugin as PluginRuntime } from "@lockcode-ai/plugin/v2/effect"
import { Plugin } from "@lockcode-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/v2/Plugin") {}
