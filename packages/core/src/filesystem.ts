...
import { Entry, FileSystem, FindInput, Match } from "@lockcode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@lockcode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/v2/FileSystem") {}
