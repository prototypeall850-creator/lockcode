...
import { Credential } from "@lockcode-ai/schema/credential"
import { Integration } from "@lockcode-ai/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/v2/Credential") {}
