...
import { Event } from "@lockcode-ai/schema/project-directories"
import { ProjectCopy } from "@lockcode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/ProjectCopy") {}
