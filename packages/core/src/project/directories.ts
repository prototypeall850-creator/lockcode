...
import type { EffectDrizzleSqlite } from "@lockcode-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@lockcode/ProjectDirectories") {}
