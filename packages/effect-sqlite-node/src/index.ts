...
export const TypeId: TypeId = "~@lockcode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@lockcode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@lockcode-ai/effect-sqlite-node/NodeSqliteClient")
